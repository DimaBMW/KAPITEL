...
import styles from "../../styles/Footer/Forter_mobile.module.scss";
import Title from "../../../../ui/title";
import Text from "../../../../ui/text";
import Form from "../../../../Form/FormBlack/FormBlack";
  ...
  return (
    <footer className={styles.footer} id="footer">
      <div className={styles.footer_container}>
        <div className={styles.footer_container__textBox}>
          <Title
            level={1}
            className="footer-title"
            text="Оставьте заявку в один клик"
          />
          <Text
            className="footer-text"
            text="Мы перезвоним вам в течение 10 минут — поможем рассчитать
                стоимость проекта под ключ и ответим на все вопросы"
          />
        </div>
        <div className={styles.footer_container__FormBox}>
          {/* <Form /> */}
          <Title
            level={1}
            className="footer-title"
            text="Форма в разработке"
          />
        </div>
        <div className={styles.footer_container__InfoBox}>
          <Title
            level={1}
            className="footer-title"
            text="Контактная информация"
          />
          <Text className="footer-text" text="9:00 – 19:00<" />
          <Text
            className="footer-text"
            text="Красных партизан 1/4, к.9, офис 20, Краснодар"
          />
