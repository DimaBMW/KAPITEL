import styles from "../../styles/Header/Header_mobile.module.scss";
import Logo from "../../../../../Mobile_Components/Logo_mobile";
import LogoBlack from "../../../../../Mobile_Components/Logo_mobile_black";
import Text from "../../../../ui/text";
import Title from "../../../../ui/title.jsx";
import Link from "../../../../ui/Link";
import Button from "../../../../ButtonMobile/Button";
import BurgerMobile from "../../../../../Mobile_Components/BurgerMobile";
import React, { useEffect, useRef, useState } from "react";
function Header() {
  const [OpenBox, setOpneBox] = useState(false);
    ...
    <header id="header" className={styles.header}>
      <div className={styles.header_container}>
        <section className={styles.header_section}>
          <div className={styles.header_cap}>
            <Logo />
            <Link href="tel:+79891412808" name="+7 (989) 141-28-08" />
            <div className={styles.header_cap_btnBox}>
              <button className={styles.header_cap__menu} onClick={openbox}>
                <BurgerMobile />
              </button>
            </div>
          </div>
          <div className={styles.header_content}>
            <div className={styles.header_content__textBox}>
              <Title
                className="header-content__text-title"
                level={1}
                text="Архитектурно-проектная организация Капитель — надежная
        ...
        <div
          className={`${styles.header_menuBox} ${
            OpenBox ? styles["is-activeBox"] : ""
          }`}
        >
          <div className={styles.header_menuBox__content}>
            <div className={styles.header_menuBox__content_cap}>
              <LogoBlack />
              <Link
                href="tel:+79891412808"
                name="+7 (989) 141-28-08"
                color="black"
              />
              <div></div>
            </div>
            <div className={styles.header_menuBox__content_nav}>
              <div className={styles.cols2_navigation}>
                <nav className={styles.navigation}>
                  <ul className={styles.navigation_list}>
                    <li className={styles.navigation_item}>
                      <Link href="https://mail.ru/" name="Проекты"color="black" />
                    </li>
                    <li className={styles.navigation_item}>
                      <Link href="https://mail.ru/" name="О нас" color="black"/>
                    </li>
                    <li className={styles.navigation_item}>
                      <Link href="https://mail.ru/" name="Работы" color="black"/>
                    </li>
                    <li className={styles.navigation_item}>
                      <Link href="https://mail.ru/" name="Контакты" color="black"/>
                    </li>
                  </ul>
                </nav>
              </div>
          ...
          <div className={styles.header_menuBox__icons}>
